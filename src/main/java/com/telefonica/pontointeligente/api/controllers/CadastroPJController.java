...
import com.telefonica.pontointeligente.api.dtos.CadastroPJDto;
...
public class CadastroPJController {
	 ...
	 * @param cadastroPJDto
	 * @param result
	 * @return ResponseEntity<CadastroPJController>
	 ...
	 * @param result
	 */
	private void validarDadosExistente(@Valid CadastroPJDto cadastroPJDto, BindingResult result) {
