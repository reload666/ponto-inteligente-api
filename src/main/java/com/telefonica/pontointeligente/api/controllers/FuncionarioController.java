...
public class FuncionarioController {
	...
	private FuncionarioDto converterFuncionarioDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhoDiaOpt().ifPresent(qtdHorasTrabaloDia -> funcionarioDto
				.setQtdHorasTrabalhoDia(Optional.of(Float.toString(qtdHorasTrabaloDia))));
	 ...
	 */
	private void atualizarDadosFuncionarios(Funcionario funcionario, @Valid FuncionarioDto funcionarioDto,
